...
<head>
    ...
    <title>Alpha 7 Seas Mission Statement &middot; Alpha 7 Seas</title>
...
<body class="page-template page-template-page-templates page-template-page_parent page-template-page-templatespage_parent-php page page-id-67 woocommerce-no-js">
    ...
    <div class="splash-wrapper content-container dark "> <img src="" alt="Alpha 7 Seas Mission Statement" width="1920" height="1080" class="seoimg">
        <div class="splash-content">
            <div class="main-title">
                <h1>Alpha 7 Seas Mission Statement</h1> </div>
        </div>
